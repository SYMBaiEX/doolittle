  ...
  const packages: NativePackageAuditRecord[] = [
    {
      ...
      alphaTagVersion: "2.0.0-alpha.81",
      compatibility: "aligned",
      note: "Primary runtime package stays on the current latest line.",
    },
    {
      ...
      alphaTagVersion: "2.0.0-alpha.81",
      compatibility: "aligned",
      note: "Core runtime stays on the latest line for stability.",
    },
    {
      ...
      alphaTagVersion: "2.0.0-alpha.81",
      compatibility: "aligned",
      note: "Used as a first-party architectural source on the same runtime line.",
    },
    {
      ...
      alphaTagVersion: "2.0.0-alpha.81",
      compatibility: "aligned",
      note: "Latest-tag skills package aligns with the active runtime line.",
    },
    {
