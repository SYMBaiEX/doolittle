...
export function buildEnvConfig(
  ...
  return {
    ...
    discordApplicationId: values.DISCORD_APPLICATION_ID,
    slackBotToken: values.SLACK_BOT_TOKEN,
    slackAppToken: values.SLACK_APP_TOKEN,
    slackUserToken: values.SLACK_USER_TOKEN,
    ...
    signalAccountNumber: values.SIGNAL_ACCOUNT_NUMBER,
    signalHttpUrl: values.SIGNAL_HTTP_URL,
    signalCliPath: values.SIGNAL_CLI_PATH,
