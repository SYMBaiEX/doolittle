...
export const REVIEW_HEADER_STATUS_CLASS =
  "review-header-status flex shrink-0 items-center gap-3.5 [&>span]:grid [&>span]:gap-0.5 [&>span]:text-right [&>span]:font-[var(--font-mono)] [&>span]:text-[length:var(--text-meta)] [&>span]:text-[var(--muted)] [&>span]:uppercase [&_strong]:text-[13px] [&_strong]:text-[var(--text)] max-[940px]:[&>span]:hidden";
...
export const REVIEW_WORK_OUTCOME_CLASS =
  "review-work-outcome flex min-w-0 items-center gap-2.25 px-3 py-2 [.is-empty_&]:px-4.5 [.is-empty_&]:py-4 [&>i]:grid [&>i]:size-6.25 [&>i]:shrink-0 [&>i]:place-items-center [&>i]:rounded-sm [&>i]:border [&>i]:border-[var(--border-strong)] [&>i]:bg-[var(--surface-soft)] [&>i]:not-italic [.good_&>i]:border-[color-mix(in_srgb,var(--good)_32%,var(--border))] [.good_&>i]:bg-[var(--good-soft)] [.good_&>i]:text-[var(--good)] [.warn_&>i]:border-[color-mix(in_srgb,var(--warn)_32%,var(--border))] [.warn_&>i]:bg-[var(--warn-soft)] [.warn_&>i]:text-[var(--warn)] [.bad_&>i]:border-[color-mix(in_srgb,var(--bad)_32%,var(--border))] [.bad_&>i]:bg-[var(--bad-soft)] [.bad_&>i]:text-[var(--bad)] [&>span]:grid [&>span]:min-w-0 [&>span]:gap-0.5 [&_small]:font-[var(--font-mono)] [&_small]:text-[length:var(--text-meta)] [&_small]:font-bold [&_small]:tracking-[0.12em] [&_small]:text-[var(--faint)] [&_small]:uppercase [&_strong]:text-xs [&_strong]:tracking-[-0.01em] [&_p]:m-0 [&_p]:truncate [&_p]:text-[length:var(--text-meta)] [&_p]:leading-[1.4] [&_p]:text-[var(--muted)]";

export const REVIEW_WORK_METRICS_CLASS =
  "review-work-metrics m-0 grid min-w-85 grid-cols-4 border-[var(--border)] border-x max-[860px]:min-w-0 max-[860px]:border-x-0 max-[860px]:border-t max-[620px]:grid-cols-2 [&>div]:grid [&>div]:min-w-16 [&>div]:content-center [&>div]:gap-0.75 [&>div]:border-[var(--border)] [&>div]:border-r [&>div]:px-2.25 [&>div]:py-1.75 [&>div]:text-center [&>div:last-child]:border-r-0 max-[620px]:[&>div:nth-child(2)]:border-r-0 max-[620px]:[&>div:nth-child(-n+2)]:border-b [&_dt]:font-[var(--font-mono)] [&_dt]:text-[length:var(--text-meta)] [&_dt]:text-[var(--faint)] [&_dt]:uppercase [&_dd]:m-0 [&_dd]:font-[var(--font-mono)] [&_dd]:text-[13px] [&_dd]:font-[750] [&_dd]:text-[var(--text-soft)] [&_.warn_dd]:text-[var(--warn)]";

export const REVIEW_WORK_REVISION_CLASS =
  "review-work-revision grid min-w-0 content-center gap-0.75 px-3 py-2 max-[1180px]:hidden [&_small]:font-[var(--font-mono)] [&_small]:text-[length:var(--text-meta)] [&_small]:font-bold [&_small]:tracking-[0.12em] [&_small]:text-[var(--faint)] [&_small]:uppercase [&_strong]:truncate [&_strong]:text-[11px] [&_code]:truncate [&_code]:text-[length:var(--text-meta)] [&_code]:text-[var(--faint)]";

export const REVIEW_EVIDENCE_DRAWER_CLASS =
  "review-evidence-drawer group shrink-0 overflow-hidden rounded-none border-0 border-[var(--border)] border-y bg-transparent [&>summary]:flex [&>summary]:min-h-9 [&>summary]:cursor-pointer [&>summary]:list-none [&>summary]:items-center [&>summary]:justify-between [&>summary]:gap-3 [&>summary]:px-0.5 [&>summary]:py-1.75 [&>summary::-webkit-details-marker]:hidden [&>summary>span]:flex [&>summary>span]:min-w-0 [&>summary>span]:items-baseline [&>summary>span]:gap-2.25 [&>summary_strong]:text-[11px] [&>summary_strong]:text-[var(--text-soft)] [&>summary_small]:truncate [&>summary_small]:font-[var(--font-mono)] [&>summary_small]:text-[length:var(--text-meta)] [&>summary_small]:text-[var(--faint)]";
...
export const REVIEW_TAB_CLASS =
  "relative flex min-h-8 items-center justify-start gap-1 rounded-t-[var(--radius-xs)] border-0 bg-transparent px-2 py-1.5 font-[var(--font-mono)] text-[length:var(--text-meta)] font-bold tracking-[0.06em] text-[var(--muted)] uppercase whitespace-nowrap hover:bg-[var(--surface-hover)] hover:text-[var(--text)] [&>span]:font-[var(--font-mono)] [&>span]:text-[length:var(--text-meta)] [&>span]:text-[var(--faint)]";
...
export const REVIEW_LIST_COPY_CLASS =
  "review-list-copy grid min-w-0 gap-0.5 [&_strong]:truncate [&_strong]:text-xs [&_small]:truncate [&_small]:text-[10px] [&_small]:text-[var(--muted)] [&_time]:font-[var(--font-mono)] [&_time]:text-[length:var(--text-meta)] [&_time]:text-[var(--faint)]";

export const REVIEW_DETAIL_CLASS =
  "review-detail min-h-0 min-w-0 overflow-auto bg-[var(--bg)] px-4 pt-3 pb-4 [scrollbar-gutter:stable]";

export const REVIEW_DETAIL_HEADER_CLASS =
  "review-detail-header flex max-w-245 items-start justify-between gap-4 pb-1.5 [&>div]:min-w-0 [&>div>span]:font-[var(--font-mono)] [&>div>span]:text-[10px] [&>div>span]:font-bold [&>div>span]:tracking-[0.1em] [&>div>span]:text-[var(--accent)] [&>div>span]:uppercase [&_h2]:mt-1 [&_h2]:mb-1 [&_h2]:font-[var(--font-display)] [&_h2]:text-[clamp(14px,1.1vw,17px)] [&_h2]:leading-[var(--line-title)] [&_h2]:[overflow-wrap:anywhere] [&_p]:m-0 [&_p]:max-w-175 [&_p]:text-xs [&_p]:leading-[var(--line-body)] [&_p]:text-[var(--muted)]";

export const REVIEW_DETAIL_BODY_CLASS = "grid max-w-245 gap-3.5 pt-4";

export const REVIEW_CI_HERO_CLASS =
  "review-ci-hero flex min-h-14.5 items-center justify-between gap-4.5 rounded-sm border border-[var(--accent-border)] bg-[color-mix(in_srgb,var(--accent)_5%,var(--surface-raised))] px-3.5 py-3 [&>div]:grid [&>div]:min-w-0 [&>div]:gap-1 [&_span]:font-[var(--font-mono)] [&_span]:text-[length:var(--text-meta)] [&_span]:font-bold [&_span]:tracking-[0.08em] [&_span]:text-[var(--accent)] [&_span]:uppercase [&_strong]:truncate [&_strong]:text-[13px] [&_a]:inline-flex [&_a]:shrink-0 [&_a]:items-center [&_a]:gap-1 [&_a]:font-[var(--font-mono)] [&_a]:text-[length:var(--text-meta)] [&_a]:font-bold [&_a]:text-[var(--accent)] [&_a]:uppercase [&_a]:no-underline [&_a:hover]:underline [&_a:hover]:[text-underline-offset:3px]";
...
export const REVIEW_CI_CHECKS_CLASS =
  "review-ci-checks overflow-hidden rounded-sm border border-[var(--border)] [&>div:first-child]:flex [&>div:first-child]:min-h-9 [&>div:first-child]:items-center [&>div:first-child]:justify-between [&>div:first-child]:border-[var(--border)] [&>div:first-child]:border-b [&>div:first-child]:bg-[var(--surface-raised)] [&>div:first-child]:px-2.75 [&>div:first-child]:py-1.75 [&>div:first-child>span]:font-[var(--font-mono)] [&>div:first-child>span]:text-[length:var(--text-meta)] [&>div:first-child>span]:font-bold [&>div:first-child>span]:tracking-[0.08em] [&>div:first-child>span]:text-[var(--accent)] [&>div:first-child>span]:uppercase [&>div:first-child>small]:font-[var(--font-mono)] [&>div:first-child>small]:text-[length:var(--text-meta)] [&>div:first-child>small]:text-[var(--muted)] [&_ul]:m-0 [&_ul]:grid [&_ul]:list-none [&_ul]:p-0 [&_li]:grid [&_li]:min-h-11.5 [&_li]:grid-cols-[7px_minmax(0,1fr)_auto_18px] [&_li]:items-center [&_li]:gap-2.5 [&_li]:border-[var(--border)] [&_li]:border-b [&_li]:px-2.75 [&_li]:py-2 [&_li:last-child]:border-b-0 [&_li>i]:size-1.5 [&_li>i]:rounded-full [&_li>i]:bg-[var(--muted)] [&_li>i.good]:bg-[var(--good)] [&_li>i.warn]:bg-[var(--warn)] [&_li>i.bad]:bg-[var(--bad)] [&_li>span]:grid [&_li>span]:min-w-0 [&_li>span]:gap-0.5 [&_li_strong]:truncate [&_li_strong]:text-[11px] [&_li_strong]:text-[var(--text-soft)] [&_li_small]:truncate [&_li_small]:text-[length:var(--text-meta)] [&_li_small]:text-[var(--muted)] [&_li>a]:text-[var(--accent)] [&_li>a]:no-underline";
...
export const REVIEW_FEEDBACK_CLASS =
  "review-feedback group block border-[var(--border)] border-b bg-[linear-gradient(110deg,color-mix(in_srgb,var(--accent)_5%,transparent),transparent_44%),var(--surface)] [&>summary]:flex [&>summary]:min-h-8.5 [&>summary]:cursor-pointer [&>summary]:list-none [&>summary]:items-center [&>summary]:justify-between [&>summary]:gap-3 [&>summary]:px-3 [&>summary]:py-1.5 [&>summary]:text-[var(--text)] [&>summary::-webkit-details-marker]:hidden [&>summary>span]:flex [&>summary>span]:items-baseline [&>summary>span]:gap-2 [&>summary_strong]:text-[11px] [&>summary_strong]:font-[750] [&>summary_small]:font-[var(--font-mono)] [&>summary_small]:text-[length:var(--text-meta)] [&>summary_small]:font-medium [&>summary_small]:text-[var(--muted)]";
...
export const REVIEW_COMMENT_LOCATION_CLASS =
  "review-comment-location flex items-center justify-between gap-2.5 [&>span]:font-[var(--font-mono)] [&>span]:text-[length:var(--text-meta)] [&>span]:font-bold [&>span]:text-[var(--accent)] [&>span]:uppercase";

export const REVIEW_COMMENT_ACTIONS_CLASS =
  "review-comment-actions flex items-center justify-end gap-1.5 [&_button]:rounded-[var(--radius-xs)] [&_button]:border-0 [&_button]:bg-transparent [&_button]:px-1.25 [&_button]:py-0.5 [&_button]:text-[length:var(--text-meta)] [&_button]:text-[var(--muted)] [&_button:hover]:bg-[var(--surface-hover)] [&_button:hover]:text-[var(--text)] [&_button.danger:hover]:bg-[var(--bad-soft)] [&_button.danger:hover]:text-[var(--bad)]";
...
export const REVIEW_COMMENT_EDITOR_CLASS =
  "review-comment-editor grid gap-1.75 rounded-[var(--radius-xs)] border border-[var(--accent-border)] bg-[var(--surface-raised)] p-2.5 shadow-[inset_2px_0_var(--accent)] [&>label]:text-[10px] [&>label]:font-bold [&>label]:text-[var(--text)] [&>code]:truncate [&>code]:text-[10px] [&>code]:text-[var(--faint)] [&>textarea]:min-h-16 [&>textarea]:w-full [&>textarea]:resize-y [&>textarea]:rounded-[var(--radius-xs)] [&>textarea]:border [&>textarea]:border-[var(--border-strong)] [&>textarea]:bg-[var(--surface)] [&>textarea]:px-2.25 [&>textarea]:py-2 [&>textarea]:text-[11px] [&>textarea]:leading-[1.5] [&>textarea]:text-[var(--text)] [&>textarea]:outline-none [&>textarea:focus]:border-[var(--accent-border)] [&>textarea:focus]:shadow-[0_0_0_2px_var(--accent-soft)] [&>small]:font-[var(--font-mono)] [&>small]:text-[length:var(--text-meta)] [&>small]:font-medium [&>small]:text-[var(--muted)] [&>div:last-child]:flex [&>div:last-child]:items-center [&>div:last-child]:justify-end [&>div:last-child]:gap-1.5 [&>div:last-child>small]:mr-auto [&_button]:min-h-6.75 [&_button]:px-2 [&_button]:py-1.25 [&_button]:text-[10px]";

export const REVIEW_DELETE_BACKDROP_CLASS =
  "fixed inset-0 z-150 grid place-items-center overflow-y-auto bg-[color-mix(in_srgb,var(--shadow)_70%,transparent)] p-4 backdrop-blur-[2px] max-[480px]:items-end max-[480px]:p-2";

export const REVIEW_DELETE_CONFIRMATION_CLASS =
  "review-delete-confirmation relative z-1 grid max-h-[calc(100svh-32px)] w-[min(440px,calc(100vw-32px))] gap-3 overflow-y-auto rounded-[var(--radius-md)] border border-[var(--bad)] bg-[var(--surface-raised)] p-5 text-[var(--text)] shadow-[var(--shell-shadow-lg)] max-[480px]:max-h-[calc(100svh-16px)] max-[480px]:w-full max-[480px]:p-4 [&_h3]:m-0 [&_p]:m-0 [&_p]:break-words [&_p]:text-xs [&_p]:leading-[1.55] [&_p]:text-[var(--text-soft)] [&>div]:flex [&>div]:justify-end [&>div]:gap-2 max-[480px]:[&>div]:flex-col-reverse [&_button]:min-h-8 [&_button]:rounded-[var(--radius-xs)] [&_button]:border [&_button]:border-[var(--border)] [&_button]:bg-[var(--surface)] [&_button]:px-3 [&_button]:py-1.5 max-[480px]:[&_button]:w-full [&_button.danger]:border-[var(--bad)] [&_button.danger]:bg-[var(--bad-soft)] [&_button.danger]:text-[var(--bad)]";
...
export const REVIEW_BRANCH_EVIDENCE_CLASS =
  "review-branch-evidence flex min-w-0 items-center justify-around gap-2.25 border-[var(--border)] border-r p-3 max-[760px]:border-r-0 max-[760px]:border-b [&_span]:grid [&_span]:gap-0.5 [&_span]:text-center [&_span]:text-[length:var(--text-meta)] [&_span]:text-[var(--muted)] [&_span]:uppercase [&_strong]:font-[var(--font-mono)] [&_strong]:text-sm [&_strong]:font-bold [&_strong]:text-[var(--text-soft)] [&_.bad_strong]:text-[var(--bad)] [&_.warn_strong]:text-[var(--warn)]";

export const REVIEW_BRANCH_EVENTS_CLASS =
  "review-branch-events m-0 grid min-w-0 list-none p-0 max-[940px]:hidden [&_li]:grid [&_li]:min-w-0 [&_li]:grid-cols-[auto_minmax(0,1fr)_auto] [&_li]:items-center [&_li]:gap-1.75 [&_li]:border-[color-mix(in_srgb,var(--border)_75%,transparent)] [&_li]:border-b [&_li]:px-2.5 [&_li]:py-1.25 [&_li:last-child]:border-b-0 [&_li>span]:font-[var(--font-mono)] [&_li>span]:text-[length:var(--text-meta)] [&_li>span]:font-bold [&_li>span]:text-[var(--accent)] [&_li>span]:uppercase [&_li>p]:m-0 [&_li>p]:truncate [&_li>p]:text-[10px] [&_li>p]:text-[var(--text-soft)] [&_li>time]:font-[var(--font-mono)] [&_li>time]:text-[length:var(--text-meta)] [&_li>time]:text-[var(--faint)] [&_li>time]:whitespace-nowrap [&_li.empty]:grid-cols-1 [&_li.empty>span]:text-[var(--muted)]";
