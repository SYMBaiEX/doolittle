...
export const REVIEW_WORK_OUTCOME_CLASS =
  "review-work-outcome flex min-w-0 items-center gap-2.25 px-3 py-2 [.is-empty_&]:px-4.5 [.is-empty_&]:py-4 [&>i]:grid [&>i]:size-6.25 [&>i]:shrink-0 [&>i]:place-items-center [&>i]:rounded-sm [&>i]:border [&>i]:border-[var(--border-strong)] [&>i]:bg-[var(--surface-soft)] [&>i]:font-[var(--font-mono)] [&>i]:text-[11px] [&>i]:font-extrabold [&>i]:not-italic [.good_&>i]:border-[color-mix(in_srgb,var(--good)_32%,var(--border))] [.good_&>i]:bg-[var(--good-soft)] [.good_&>i]:text-[var(--good)] [.warn_&>i]:border-[color-mix(in_srgb,var(--warn)_32%,var(--border))] [.warn_&>i]:bg-[var(--warn-soft)] [.warn_&>i]:text-[var(--warn)] [.bad_&>i]:border-[color-mix(in_srgb,var(--bad)_32%,var(--border))] [.bad_&>i]:bg-[var(--bad-soft)] [.bad_&>i]:text-[var(--bad)] [&>span]:grid [&>span]:min-w-0 [&>span]:gap-0.5 [&_small]:font-[var(--font-mono)] [&_small]:text-[length:var(--text-meta)] [&_small]:font-bold [&_small]:tracking-[0.12em] [&_small]:text-[var(--faint)] [&_small]:uppercase [&_strong]:text-xs [&_strong]:tracking-[-0.01em] [&_p]:m-0 [&_p]:truncate [&_p]:text-[length:var(--text-meta)] [&_p]:leading-[1.4] [&_p]:text-[var(--muted)]";
...
export const REVIEW_DETAIL_HEADER_CLASS =
  "review-detail-header flex max-w-245 items-start justify-between gap-4 border-[color-mix(in_srgb,var(--border)_72%,transparent)] border-b pb-2.5 [&>div]:min-w-0 [&>div>span]:font-[var(--font-mono)] [&>div>span]:text-[10px] [&>div>span]:font-bold [&>div>span]:tracking-[0.1em] [&>div>span]:text-[var(--accent)] [&>div>span]:uppercase [&_h2]:mt-1 [&_h2]:mb-1 [&_h2]:font-[var(--font-display)] [&_h2]:text-[clamp(14px,1.1vw,17px)] [&_h2]:leading-[var(--line-title)] [&_h2]:[overflow-wrap:anywhere] [&_p]:m-0 [&_p]:max-w-175 [&_p]:text-xs [&_p]:leading-[var(--line-body)] [&_p]:text-[var(--muted)]";

export const REVIEW_DETAIL_BODY_CLASS = "grid max-w-245 gap-3.5 pt-4";

export const REVIEW_CI_HERO_CLASS =
  "review-ci-hero flex min-h-14.5 items-center justify-between gap-4.5 rounded-sm border border-[var(--accent-border)] bg-[color-mix(in_srgb,var(--accent)_5%,var(--surface-raised))] px-3.5 py-3 [&>div]:grid [&>div]:min-w-0 [&>div]:gap-1 [&_span]:font-[var(--font-mono)] [&_span]:text-[length:var(--text-meta)] [&_span]:font-bold [&_span]:tracking-[0.08em] [&_span]:text-[var(--accent)] [&_span]:uppercase [&_strong]:truncate [&_strong]:text-[13px] [&_a]:shrink-0 [&_a]:font-[var(--font-mono)] [&_a]:text-[length:var(--text-meta)] [&_a]:font-bold [&_a]:text-[var(--accent)] [&_a]:uppercase [&_a]:no-underline [&_a:hover]:underline [&_a:hover]:[text-underline-offset:3px]";
