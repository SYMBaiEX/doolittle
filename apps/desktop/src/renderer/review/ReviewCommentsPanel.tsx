    ...
    >
      ...
      {comments.length > 0 ? (
          ...
          {comments.map((comment) => (
            ...
            >
              <div className="review-comment-location">
                ...
                <Badge tone={comment.status === "open" ? "warn" : "neutral"}>
                  {comment.status}
                </Badge>
              </div>
        ...
        <p className="review-feedback-empty">
          Add a file note or use the <strong>+</strong> control beside a diff
          line. Drafts stay local to this workspace and revision.
        </p>
      )}
