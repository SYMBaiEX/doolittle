...
export const PROVIDER_SECTION_HEADING_CLASS =
  "provider-section-heading flex items-center justify-between gap-6 px-0.5 max-[860px]:items-start max-[860px]:flex-col max-[860px]:gap-1.75 [&>div]:grid [&>div]:gap-1 [&_h2]:m-0 [&_h2]:font-[var(--font-display)] [&_h2]:text-[17px] [&_h2]:font-[650] [&_h2]:tracking-[-0.02em]";
...
export const PROVIDER_CONNECTION_TITLE_CLASS =
  "provider-connection-title flex items-center gap-2.25 [&_h3]:m-0 [&_h3]:font-[var(--font-display)] [&_h3]:text-[15px] [&_h3]:font-[650] [&_h3]:tracking-[-0.015em]";

export const PROVIDER_STATUS_LINE_CLASS =
  "provider-connection-status-line flex min-w-0 items-center gap-1.75 text-[var(--muted)] [&>span]:size-1.5 [&>span]:shrink-0 [&>span]:rounded-full [&>p]:m-0 [&>p]:truncate [&>p]:text-[var(--text-meta)]";

export const PROVIDER_FACTS_CLASS =
  "provider-connection-facts m-0 flex min-w-0 overflow-hidden text-[var(--muted)] max-[620px]:flex-wrap [&>div]:flex [&>div]:min-w-0 [&>div]:items-center [&>div+div]:before:px-1.5 [&>div+div]:before:text-[var(--line-strong)] [&>div+div]:before:content-['·'] [&_dd]:m-0 [&_dd]:max-w-[min(28vw,260px)] [&_dd]:truncate [&_dd]:text-[var(--text-meta)]";
...
export const PROVIDER_CONNECTION_MENU_CLASS =
  "provider-connection-menu min-w-34.5 [&_[role=menuitem]]:text-[var(--text-control)]";

export const PROVIDER_ROUTING_DISCLOSURE_CLASS =
  "provider-routing-disclosure overflow-hidden rounded-[5px] border border-[var(--border)] bg-[color-mix(in_srgb,var(--surface)_92%,transparent)] pt-0 [&>summary]:flex [&>summary]:min-h-14.5 [&>summary]:cursor-pointer [&>summary]:list-none [&>summary]:items-center [&>summary]:justify-between [&>summary]:gap-4.5 [&>summary]:px-3.25 [&>summary]:py-2.25 [&>summary::-webkit-details-marker]:hidden [&>summary>span:first-child]:grid [&>summary>span:first-child]:gap-0.5 [&>summary_strong]:font-[var(--font-display)] [&>summary_strong]:text-base [&>summary_small]:text-[var(--muted)] [&>summary_small]:text-[var(--text-meta)] [&>summary>span:last-child]:font-[var(--font-mono)] [&>summary>span:last-child]:text-[var(--accent)] [&>summary>span:last-child]:text-[var(--text-meta)] [&>summary>span:last-child]:uppercase";
...
export const PROVIDER_POOL_TITLE_CLASS =
  "provider-pool-panel__title grid gap-0.5 [&_h3]:m-0 [&_h3]:font-[var(--font-display)] [&_h3]:text-[15px] [&_h3]:font-[650] [&_h3]:tracking-[-0.015em] [&_p]:m-0 [&_p]:text-[var(--text-meta)] [&_p]:leading-[1.55] [&_p]:text-[var(--text-soft)]";
...
export const PROVIDER_POOL_ROUTING_LABEL_CLASS =
  "provider-pool-routing__label font-[var(--font-mono)] text-[var(--text-meta)] tracking-[0.08em] text-[var(--muted)] uppercase";
...
export const PROVIDER_POOL_DIRECTORY_HEADER_CLASS =
  "provider-pool-directory__header flex items-center justify-between gap-2.5 min-[900px]:items-start max-[860px]:items-start max-[860px]:flex-col [&>div]:flex [&>div]:items-baseline [&>div]:gap-1.75 [&_h4]:m-0 [&_h4]:text-[var(--text-control)] [&_h4]:text-[var(--text)] [&>small]:text-right [&>small]:text-[var(--muted)] [&>small]:text-[var(--text-meta)] min-[900px]:[&>small]:max-w-45 max-[860px]:[&>small]:text-left";

export const PROVIDER_POOL_COUNT_CLASS =
  "provider-pool-count font-[var(--font-mono)] text-[var(--text-meta)] text-[var(--muted)]";

export const PROVIDER_POOL_EMPTY_CLASS =
  "provider-pool-empty-copy m-0 px-0 pt-0.5 pb-1 text-[var(--text-meta)] text-[var(--muted)]";
...
export const PROVIDER_IMPORT_DISCLOSURE_CLASS =
  "provider-import-disclosure border-[var(--line-subtle)] border-t [&>summary]:flex [&>summary]:min-h-8 [&>summary]:cursor-pointer [&>summary]:list-none [&>summary]:items-center [&>summary]:justify-between [&>summary]:gap-3 [&>summary]:px-px [&>summary]:pt-1.5 [&>summary]:pb-0.5 [&>summary]:text-[var(--text-soft)] [&>summary::-webkit-details-marker]:hidden [&>summary>span:first-child]:grid [&>summary>span:first-child]:gap-0.5 [&>summary_strong]:text-[var(--text-control)] [&>summary>span:last-child]:grid [&>summary>span:last-child]:size-5.5 [&>summary>span:last-child]:place-items-center [&>summary>span:last-child]:rounded-[3px] [&>summary>span:last-child]:border [&>summary>span:last-child]:border-[var(--line-subtle)] [&>summary>span:last-child]:text-[15px] [&>summary>span:last-child]:text-[var(--accent)] [&[open]>summary>span:last-child]:rotate-45";

export const PROVIDER_IMPORT_FORM_CLASS =
  "provider-import-form grid grid-cols-2 gap-2.25 px-0 pt-2 pb-0.5 max-[620px]:grid-cols-1 [&_.form-field]:grid [&_.form-field]:gap-1 [&_.form-field>span]:font-[var(--font-mono)] [&_.form-field>span]:text-[var(--muted)] [&_.form-field>span]:text-[var(--text-meta)] [&_.form-field>span]:tracking-[0.05em] [&_.form-field>span]:uppercase";

export const PROVIDER_IMPORT_ACTION_CLASS =
  "provider-import-action col-span-full flex items-center justify-between gap-4.5 max-[860px]:items-start max-[860px]:flex-col max-[620px]:col-span-1 [&_p]:m-0 [&_p]:max-w-155 [&_p]:text-[var(--text-meta)] [&_p]:leading-[1.55] [&_p]:text-[var(--text-soft)]";
