...
export const COMMAND_PALETTE_LOADING_STATUS_CLASS =
  "command-palette-loading__status mx-2.5 mt-1.25 mb-2.5 flex min-h-16 items-center gap-2.5 rounded-[10px] border border-[var(--border)] bg-[var(--surface)] px-4 text-[var(--text-sm)] text-[var(--muted)] [&_i]:size-2 [&_i]:shrink-0 [&_i]:animate-pulse [&_i]:rounded-full [&_i]:bg-[var(--accent)] [&_i]:shadow-[0_0_0_4px_color-mix(in_srgb,var(--accent)_10%,transparent)] motion-reduce:[&_i]:animate-none";
