...
export const WINDOW_DRAGBAR_CLASS =
  "window-dragbar relative flex min-h-11 shrink-0 flex-col items-stretch gap-0 border-b border-[var(--line-subtle)] bg-[color-mix(in_srgb,var(--bg)_97%,var(--surface))] text-[var(--muted)] [-webkit-app-region:drag]";

export const WINDOW_DRAGBAR_CHAT_CLASS =
  "window-dragbar--chat flex basis-11 bg-[color-mix(in_srgb,var(--bg)_98%,var(--surface))] border-[color-mix(in_srgb,var(--border)_64%,transparent)] max-[1440px]:[&_.window-context]:hidden max-[760px]:basis-17 max-[760px]:min-h-17 max-[760px]:[&_.window-dragbar-primary]:grid max-[760px]:[&_.window-dragbar-primary]:min-h-17 max-[760px]:[&_.window-dragbar-primary]:grid-cols-[auto_minmax(0,1fr)_auto] max-[760px]:[&_.window-dragbar-primary]:grid-rows-[34px_34px] max-[760px]:[&_.window-dragbar-primary]:gap-x-1.5 max-[760px]:[&_.window-dragbar-primary]:px-2 max-[760px]:[&_.menu-button]:col-start-1 max-[760px]:[&_.menu-button]:row-start-1 max-[760px]:[&_.window-tools]:col-start-3 max-[760px]:[&_.window-tools]:row-start-1 max-[760px]:[&_.chat-chrome-host]:col-span-full max-[760px]:[&_.chat-chrome-host]:row-start-2";
...
export const APP_BRAND_CLASS =
  "app-brand relative flex min-h-15.5 shrink-0 items-center gap-2.75 border-b border-[color-mix(in_srgb,var(--border)_76%,transparent)] px-1 pt-1 pb-3";
...
export const SIDEBAR_QUICK_ACTIONS_CLASS =
  "sidebar-quick-actions grid shrink-0 grid-cols-2 gap-1.25 py-2.25 pt-3 [-webkit-app-region:no-drag] [&>.sidebar-new-chat-shell]:col-span-2 [&>button]:grid [&>button]:min-h-8 [&>button]:grid-cols-[16px_minmax(0,1fr)] [&>button]:items-center [&>button]:gap-1.75 [&>button]:rounded-[var(--radius-sm)] [&>button]:border [&>button]:border-transparent [&>button]:bg-transparent [&>button]:px-2 [&>button]:py-1.25 [&>button]:text-left [&>button]:text-[var(--text-soft)] [&>button:hover]:bg-[color-mix(in_srgb,var(--surface-hover)_78%,transparent)] [&>button:hover]:text-[var(--text)] [&_button>span]:text-center [&_button>span]:text-[15px] [&_button>span]:text-[var(--accent)] [&_button_kbd]:hidden [&_button_strong]:overflow-hidden [&_button_strong]:text-ellipsis [&_button_strong]:whitespace-nowrap [&_button_strong]:text-xs [&_button_strong]:font-semibold [&_.sidebar-new-chat-shell>button]:min-h-9.5 [&_.sidebar-new-chat-shell>button]:grid-cols-[20px_minmax(0,1fr)_auto] [&_.sidebar-new-chat-shell>button]:border-[color-mix(in_srgb,var(--accent)_15%,var(--border))] [&_.sidebar-new-chat-shell>button]:bg-[color-mix(in_srgb,var(--accent)_8%,var(--surface-soft))] [&_.sidebar-new-chat-shell>button]:text-[var(--text)]";
...
export const SIDEBAR_DOCK_HEADING_CLASS =
  "sidebar-dock-heading flex items-center justify-between px-1 font-[var(--font-mono)] text-[8px] font-bold tracking-[0.14em] text-[var(--faint)] uppercase [&>i]:not-italic [&>i]:tracking-[-0.08em] [&>i]:text-[var(--accent)]";
...
export const SIDEBAR_MODE_BUTTON_CLASS =
  "relative grid min-h-11.5 w-full grid-cols-1 place-items-center gap-0.75 rounded-[7px] border border-transparent bg-transparent px-1 py-1.25 text-[10px] font-semibold text-[var(--muted)] hover:bg-[color-mix(in_srgb,var(--surface-hover)_78%,transparent)] hover:text-[var(--text)] [&>.icon]:size-4";
...
export const SIDEBAR_UTILITY_BUTTON_CLASS =
  "sidebar-utility-button grid min-h-12 grid-cols-[32px_minmax(0,1fr)_auto] items-center gap-2.25 rounded-[9px] border border-transparent bg-transparent px-1.75 py-1.5 text-left text-[var(--muted)] hover:border-[var(--border)] hover:bg-[var(--surface-hover)] hover:text-[var(--text)]";
...
export const SIDEBAR_UTILITY_MARK_CLASS =
  "sidebar-utility-mark grid size-8 place-items-center rounded-lg border border-[var(--border)] bg-[var(--surface-soft)] text-[var(--muted)]";
...
export const SIDEBAR_UTILITY_COPY_CLASS =
  "sidebar-utility-copy grid min-w-0 gap-0.5 [&>small]:overflow-hidden [&>small]:text-ellipsis [&>small]:whitespace-nowrap [&>small]:font-[var(--font-mono)] [&>small]:text-[8px] [&>small]:text-[var(--faint)] [&>strong]:overflow-hidden [&>strong]:text-ellipsis [&>strong]:whitespace-nowrap [&>strong]:text-[11px] [&>strong]:font-semibold [&>strong]:text-[var(--text-soft)]";
export const SIDEBAR_UTILITY_SHORTCUT_CLASS =
  "sidebar-utility-shortcut rounded border border-[var(--border)] bg-[var(--surface-soft)] px-1.25 py-0.5 font-[var(--font-mono)] text-[8px] font-medium text-[var(--faint)]";
