...
export const ROUTE_DIALOG_HEADER_CLASS =
  "route-control-header flex items-start justify-between gap-4 border-b border-[var(--border)] pb-3 [&_h2]:mt-1 [&_h2]:mb-1 [&_h2]:text-[clamp(15px,1.2vw,18px)] [&_h2]:leading-[var(--line-title)] [&_p]:m-0 [&_p]:max-w-140 [&_p]:leading-[var(--line-body)] [&_p]:text-[var(--muted)]";
