...
export const ROUTE_DIALOG_HEADER_CLASS =
  "route-control-header flex items-start justify-between gap-6 border-b border-[var(--border)] pb-4.5 [&_h2]:mt-1.25 [&_h2]:mb-1.75 [&_h2]:text-[clamp(23px,3vw,34px)] [&_h2]:leading-none [&_p]:m-0 [&_p]:max-w-140 [&_p]:leading-[1.55] [&_p]:text-[var(--muted)]";
