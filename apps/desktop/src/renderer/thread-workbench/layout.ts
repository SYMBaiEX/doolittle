...
export const WORKBENCH_LOCKUP_CLASS =
  "thread-workbench-lockup flex min-w-0 items-center gap-2.25 [&>div]:grid [&>div]:min-w-0 [&>div]:gap-px [&_small]:truncate [&_small]:font-[var(--font-mono)] [&_small]:text-[length:var(--text-meta)] [&_small]:leading-[1.2] [&_small]:text-[color-mix(in_srgb,currentColor_42%,transparent)] [&_strong]:truncate [&_strong]:text-sm [&_strong]:tracking-[-0.01em] max-[960px]:[&_strong]:text-[13px]";

export const WORKBENCH_MARK_CLASS =
  "thread-workbench-mark relative grid size-8.5 shrink-0 place-items-center rounded-[7px] border border-[color-mix(in_srgb,var(--accent)_27%,var(--border))] bg-[color-mix(in_srgb,var(--accent)_9%,var(--surface))] font-[var(--font-mono)] text-[length:var(--text-meta)] leading-none font-[750] tracking-[0.06em] text-[var(--accent)] [&>i]:absolute [&>i]:top-1.25 [&>i]:right-1.25 [&>i]:size-1 [&>i]:rounded-full [&>i]:bg-[var(--accent)] [&>i]:shadow-[0_0_8px_color-mix(in_srgb,var(--accent)_72%,transparent)]";
...
export const WORKBENCH_PANEL_HEADING_CLASS =
  "thread-workbench-panel-heading flex min-h-9.5 shrink-0 items-start justify-between gap-2.5 rounded-[5px] border border-[color-mix(in_srgb,var(--border)_72%,transparent)] bg-[color-mix(in_srgb,var(--surface-raised)_44%,transparent)] px-2 py-1.5 [&>div]:flex [&>div]:min-w-0 [&>div]:items-baseline [&>div]:gap-2 [&_small]:font-[var(--font-mono)] [&_small]:text-[length:var(--text-meta)] [&_small]:leading-[1.2] [&_small]:text-[color-mix(in_srgb,currentColor_50%,transparent)]";
...
export const WORKBENCH_TREE_CLASS =
  "thread-workbench-tree min-h-0 min-w-0 overflow-hidden rounded-lg border border-[color-mix(in_srgb,currentColor_8%,transparent)] bg-[color-mix(in_srgb,black_16%,transparent)] [&_.workspace-file-tree-shell]:h-full [&_.workspace-file-tree-shell]:min-h-0 [&_.workspace-file-tree-header]:min-h-8.5 [&_.workspace-file-tree-header]:bg-[color-mix(in_srgb,currentColor_3%,transparent)] [&_.workspace-file-tree-header]:py-1 [&_.workspace-file-tree-header_strong]:text-[length:var(--text-meta)] [&_.workspace-file-tree-header_span]:text-[length:var(--text-meta)] [&_.workspace-tree-extension]:text-[length:var(--text-meta)] [&_.workspace-file-tree]:p-1 [&_.workspace-file-tree_[role=treeitem]]:min-h-6.25 [&_.workspace-file-tree_[role=treeitem]]:py-0.5 [&_.workspace-tree-name]:text-[10px]";
