...
export const WORKBENCH_HEADER_CLASS =
  "thread-workbench-header grid gap-1 border-[color-mix(in_srgb,currentColor_9%,transparent)] border-b bg-[color-mix(in_srgb,var(--surface-raised)_58%,transparent)] px-1.5 py-1.25";
...
export const WORKBENCH_LOCKUP_CLASS =
  "thread-workbench-lockup flex min-w-0 items-center gap-1.75 [&>div]:grid [&>div]:min-w-0 [&>div]:gap-px [&_small]:truncate [&_small]:font-[var(--font-mono)] [&_small]:text-[length:var(--text-meta)] [&_small]:leading-[1.2] [&_small]:text-[color-mix(in_srgb,currentColor_42%,transparent)] [&_strong]:truncate [&_strong]:text-[13px] [&_strong]:tracking-[-0.01em]";

export const WORKBENCH_MARK_CLASS =
  "thread-workbench-mark relative grid size-7 shrink-0 place-items-center rounded-[5px] border border-[color-mix(in_srgb,var(--accent)_27%,var(--border))] bg-[color-mix(in_srgb,var(--accent)_9%,var(--surface))] font-[var(--font-mono)] text-[length:var(--text-meta)] leading-none font-[750] tracking-[0.06em] text-[var(--accent)] [&>i]:absolute [&>i]:top-1 [&>i]:right-1 [&>i]:size-1 [&>i]:rounded-full [&>i]:bg-[var(--accent)]";
...
export const WORKBENCH_ICON_BUTTON_CLASS =
  "thread-workbench-icon-button inline-flex size-5.75 cursor-pointer items-center justify-center rounded-[7px] border-0 bg-transparent p-0 text-[color-mix(in_srgb,currentColor_62%,transparent)] hover:bg-[color-mix(in_srgb,currentColor_8%,transparent)] hover:text-[var(--text)] focus-visible:bg-[color-mix(in_srgb,currentColor_8%,transparent)] focus-visible:text-[var(--text)] focus-visible:outline focus-visible:outline-1 focus-visible:-outline-offset-1 focus-visible:outline-[var(--accent-border)] max-[720px]:size-6.5";
...
export const WORKBENCH_CONTEXT_COPY_CLASS =
  "thread-workbench-context-copy grid min-w-0 flex-1 gap-0.75 [&_strong]:truncate [&_strong]:font-[var(--font-mono)] [&_strong]:text-[11px] [&_strong]:leading-[1.2] [&_strong]:font-semibold [&_small]:truncate [&_small]:text-[10px] [&_small]:text-[color-mix(in_srgb,currentColor_53%,transparent)] max-[1180px]:[&_small]:hidden";
...
export const WORKBENCH_TABS_CLASS =
  "thread-workbench-tabs flex min-w-0 items-stretch gap-0.5 overflow-x-auto border-[color-mix(in_srgb,currentColor_9%,transparent)] border-b bg-[color-mix(in_srgb,var(--surface-raised)_32%,transparent)] px-0.75 py-0.75 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden";

export const WORKBENCH_TAB_CLASS =
  "relative grid min-h-7.25 min-w-[3rem] flex-1 basis-0 cursor-pointer place-items-center rounded-[4px] border border-transparent bg-transparent p-0.75 text-[color-mix(in_srgb,currentColor_48%,transparent)] hover:bg-[color-mix(in_srgb,currentColor_5%,transparent)] hover:text-[var(--text)] focus-visible:bg-[color-mix(in_srgb,currentColor_5%,transparent)] focus-visible:text-[var(--text)] focus-visible:outline focus-visible:outline-1 focus-visible:-outline-offset-1 focus-visible:outline-[var(--accent-border)] max-[1040px]:min-w-[2.625rem]";
...
export const WORKBENCH_TREE_CLASS =
  "thread-workbench-tree min-h-0 min-w-0 overflow-hidden rounded-lg border border-[color-mix(in_srgb,currentColor_8%,transparent)] bg-[color-mix(in_srgb,var(--surface-soft)_82%,var(--bg))] [&_.workspace-file-tree-shell]:h-full [&_.workspace-file-tree-shell]:min-h-0 [&_.workspace-file-tree-header]:min-h-8.5 [&_.workspace-file-tree-header]:bg-[color-mix(in_srgb,currentColor_3%,transparent)] [&_.workspace-file-tree-header]:py-1 [&_.workspace-file-tree-header_strong]:text-[length:var(--text-meta)] [&_.workspace-file-tree-header_span]:text-[length:var(--text-meta)] [&_.workspace-tree-extension]:text-[length:var(--text-meta)] [&_.workspace-file-tree]:p-1 [&_.workspace-file-tree_[role=treeitem]]:min-h-6.25 [&_.workspace-file-tree_[role=treeitem]]:py-0.5 [&_.workspace-tree-name]:text-[length:var(--text-meta)]";
...
export const WORKBENCH_PREVIEW_CLASS =
  "thread-workbench-preview grid min-h-0 min-w-0 grid-rows-[auto_minmax(0,1fr)] overflow-hidden rounded-lg border border-[color-mix(in_srgb,currentColor_8%,transparent)] bg-[color-mix(in_srgb,var(--surface)_88%,var(--bg))] [&>div:first-child]:flex [&>div:first-child]:min-h-8 [&>div:first-child]:items-center [&>div:first-child]:justify-between [&>div:first-child]:gap-2 [&>div:first-child]:border-[color-mix(in_srgb,currentColor_8%,transparent)] [&>div:first-child]:border-b [&>div:first-child]:py-1 [&>div:first-child]:pr-1.75 [&>div:first-child]:pl-2.5 [&_button]:cursor-pointer [&_button]:border-0 [&_button]:bg-transparent [&_button]:p-1.25 [&_button]:text-[10px] [&_button]:leading-none [&_button]:font-semibold [&_button]:text-[var(--accent)] [&_button:hover]:underline [&_button:focus-visible]:underline [&_button:disabled]:cursor-default [&_button:disabled]:opacity-42 [&_button:disabled]:no-underline [&_code]:truncate [&_code]:font-[var(--font-mono)] [&_code]:text-[length:var(--text-meta)] [&_code]:leading-[1.2] [&_code]:text-[color-mix(in_srgb,currentColor_65%,transparent)] [&_pre]:m-0 [&_pre]:overflow-auto [&_pre]:overscroll-contain [&_pre]:p-2.5 [&_pre]:font-[var(--font-mono)] [&_pre]:text-[length:var(--text-meta)] [&_pre]:leading-[1.45] [&_pre]:text-[color-mix(in_srgb,currentColor_72%,transparent)] [&_pre]:[scrollbar-gutter:stable] [&_pre]:[tab-size:2] [&_pre]:whitespace-pre-wrap";

export const WORKBENCH_CODE_PREVIEW_CLASS = `${WORKBENCH_PREVIEW_CLASS} thread-workbench-code-preview relative [&>div:first-child]:grid [&>div:first-child]:grid-cols-[minmax(0,1fr)_auto_auto] [&>div:first-child>span]:font-[var(--font-mono)] [&>div:first-child>span]:text-[length:var(--text-meta)] [&>div:first-child>span]:leading-none [&>div:first-child>span]:font-bold [&>div:first-child>span]:tracking-[0.06em] [&>div:first-child>span]:text-[var(--accent)] [&>div:first-child>span]:uppercase [&>div:first-child>div]:flex [&>div:first-child>div]:shrink-0 [&>div:first-child>div]:gap-0.5`;
...
export const WORKBENCH_FILE_EMPTY_CLASS =
  "thread-workbench-file-empty flex min-h-0 flex-col items-center justify-center gap-1.5 p-5 text-center text-[color-mix(in_srgb,currentColor_48%,transparent)] [&_strong]:text-[11px] [&_strong]:text-[var(--text)] [&_p]:m-0 [&_p]:max-w-57.5 [&_p]:text-[length:var(--text-meta)] [&_p]:leading-[1.45]";
...
export const WORKBENCH_LIST_BUTTON_CLASS =
  "grid min-h-6.75 cursor-pointer grid-cols-[14px_minmax(0,1fr)_auto] items-center gap-1.75 rounded-md border-0 bg-transparent px-1.75 py-1 text-left font-[var(--font-mono)] text-[length:var(--text-meta)] leading-[1.35] text-[color-mix(in_srgb,currentColor_72%,transparent)] hover:bg-[color-mix(in_srgb,currentColor_6%,transparent)] hover:text-[var(--text)] focus-visible:bg-[color-mix(in_srgb,currentColor_6%,transparent)] focus-visible:text-[var(--text)] focus-visible:outline focus-visible:outline-1 focus-visible:-outline-offset-1 focus-visible:outline-[var(--accent-border)] disabled:cursor-default disabled:opacity-66 [&>span:nth-child(2)]:truncate [&_small]:text-[length:var(--text-meta)] [&_small]:text-[color-mix(in_srgb,currentColor_43%,transparent)]";
...
export const WORKBENCH_PLAN_CARD_CLASS =
  "thread-workbench-plan-card rounded-lg border border-[color-mix(in_srgb,currentColor_7%,transparent)] bg-[color-mix(in_srgb,currentColor_3%,transparent)] p-2.5 [&>div]:flex [&>div]:items-center [&>div]:justify-between [&>div]:gap-2 [&_strong]:text-[11px] [&_p]:my-1.75 [&_p]:text-[10px] [&_p]:leading-[1.5] [&_p]:text-[color-mix(in_srgb,currentColor_65%,transparent)] [&>small]:font-[var(--font-mono)] [&>small]:text-[length:var(--text-meta)] [&>small]:leading-[1.3] [&>small]:text-[color-mix(in_srgb,currentColor_40%,transparent)]";

export const WORKBENCH_BRIEF_CLASS =
  "thread-workbench-brief grid min-h-0 min-w-0 flex-1 grid-cols-1 gap-2.5 overflow-auto overscroll-contain [scrollbar-gutter:stable] [&>section]:rounded-[10px] [&>section]:border [&>section]:border-[color-mix(in_srgb,currentColor_8%,transparent)] [&>section]:bg-[color-mix(in_srgb,currentColor_3%,transparent)] [&>section]:p-2.5 [&>section>h3]:mt-0 [&>section>h3]:mb-2 [&>section>h3]:text-[10px] [&>section>h3]:font-semibold [&>section>h3]:tracking-[0.03em] [&>section>h3]:uppercase [&_article]:mb-1.75 [&_article>div]:mb-1.75 [&_article>div]:flex [&_article>div]:items-baseline [&_article>div]:justify-between [&_article>div]:gap-2 [&_article>div_span]:text-[length:var(--text-meta)] [&_article>div_span]:text-[color-mix(in_srgb,currentColor_46%,transparent)] [&_article>div_strong]:text-right [&_article>div_strong]:text-[11px] [&_article>p]:mt-0 [&_article>p]:mb-1.75 [&_article>p]:text-[10px] [&_article>p]:leading-[1.45] [&_article>p]:text-[color-mix(in_srgb,currentColor_64%,transparent)] [&_article>button]:cursor-pointer [&_article>button]:rounded-md [&_article>button]:border [&_article>button]:border-[color-mix(in_srgb,var(--accent)_34%,transparent)] [&_article>button]:bg-[var(--thread-workbench-accent-soft)] [&_article>button]:px-2.25 [&_article>button]:py-1.75 [&_article>button]:font-[var(--font-mono)] [&_article>button]:text-[length:var(--text-meta)] [&_article>button]:leading-none [&_article>button]:font-[680] [&_article>button]:text-[var(--accent)] [&_article>button:hover]:bg-[color-mix(in_srgb,var(--accent)_20%,transparent)] [&_article>button:focus-visible]:bg-[color-mix(in_srgb,var(--accent)_20%,transparent)] [&_article>button:focus-visible]:outline-none";
...
export const WORKBENCH_BRIEF_STAT_CLASS =
  "thread-workbench-brief-stat py-1.75 [&_span]:block [&_strong]:my-1 [&_strong]:block [&_small]:block [&_small]:text-[length:var(--text-meta)] [&_small]:text-[color-mix(in_srgb,currentColor_46%,transparent)]";
