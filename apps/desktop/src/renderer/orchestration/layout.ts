const FORM_LABEL =
  "[&_label]:grid [&_label]:min-w-0 [&_label]:gap-1 [&_label]:text-[length:var(--text-meta)] [&_label]:font-semibold [&_label]:text-[var(--muted)] [&_label>span]:font-[var(--font-mono)] [&_label>span]:text-[length:var(--text-meta)] [&_label>span]:tracking-[0.08em] [&_label>span]:text-[var(--faint)] [&_label>span]:uppercase";
...
const ORCHESTRATION_CLASS = {
  ...
  "orchestration-header":
    "orchestration-header flex min-h-13 shrink-0 items-center justify-between gap-4 border-[var(--border)] border-b bg-[var(--surface)] px-3 py-1.75 [&>div:first-child]:min-w-0 [&_.eyebrow]:text-[length:var(--text-meta)] [&_.eyebrow]:tracking-[0.1em] [&_.eyebrow]:text-[var(--accent)] [&_h1]:m-0 [&_h1]:font-[var(--font-display)] [&_h1]:text-sm [&_h1]:font-semibold [&_h1]:tracking-[-0.01em] [&_p]:mt-px [&_p]:mb-0 [&_p]:text-[length:var(--text-meta)] [&_p]:text-[var(--muted)] max-[680px]:min-h-15.5 max-[680px]:px-3 max-[680px]:py-2.5 max-[900px]:[&_p]:hidden",
  ...
  "orchestration-summary-chip":
    "orchestration-summary-chip inline-flex min-h-6 min-w-0 items-center justify-center gap-1.25 border-0 border-l border-l-[var(--border)] bg-transparent px-2.25 py-0.5 text-[10px] text-[var(--text-soft)] whitespace-nowrap [&_strong]:font-[var(--font-mono)] [&_strong]:text-[11px] [&_strong]:leading-none [&_small]:font-[var(--font-mono)] [&_small]:text-[length:var(--text-meta)] [&_small]:tracking-[0.08em] [&_small]:text-[var(--muted)] [&_small]:uppercase max-[680px]:hidden",
  ...
  "orchestration-nav-main":
    "orchestration-nav-main flex min-w-0 shrink-0 items-stretch gap-1 max-[680px]:w-full",
  "orchestration-tabs":
    "orchestration-tabs flex min-h-10.5 self-stretch [&>button]:relative [&>button]:inline-flex [&>button]:min-w-18.5 [&>button]:items-center [&>button]:justify-start [&>button]:gap-1.5 [&>button]:border-0 [&>button]:bg-transparent [&>button]:px-2.75 [&>button]:font-[var(--font-mono)] [&>button]:text-[length:var(--text-meta)] [&>button]:font-semibold [&>button]:tracking-[0.07em] [&>button]:text-[var(--muted)] [&>button]:uppercase [&>button:hover]:bg-[var(--surface-hover)] [&>button:hover]:text-[var(--text)] [&>button:focus-visible]:bg-[var(--surface-hover)] [&>button:focus-visible]:text-[var(--text)] [&>button.selected]:text-[var(--text)] [&>button.selected]:after:absolute [&>button.selected]:after:right-2.5 [&>button.selected]:after:bottom-[-1px] [&>button.selected]:after:left-2.5 [&>button.selected]:after:h-0.5 [&>button.selected]:after:bg-[var(--accent)] [&>button.selected]:after:content-[''] [&>button>span]:min-w-4.25 [&>button>span]:px-1 [&>button>span]:py-px [&>button>span]:font-[var(--font-mono)] [&>button>span]:text-[length:var(--text-meta)] [&>button>span]:font-bold [&>button>span]:text-[var(--muted)] max-[680px]:flex-1 max-[680px]:[&>button]:min-w-0 max-[680px]:[&>button]:flex-1 max-[680px]:[&>button]:justify-center max-[680px]:[&>button]:px-1.5",
  "orchestration-section-menu":
    "orchestration-section-menu group relative self-center [&>summary]:flex [&>summary]:min-h-7 [&>summary]:min-w-18 [&>summary]:cursor-pointer [&>summary]:list-none [&>summary]:items-center [&>summary]:justify-between [&>summary]:gap-2 [&>summary]:rounded-[var(--radius-xs)] [&>summary]:border [&>summary]:border-[var(--border)] [&>summary]:bg-[var(--surface-raised)] [&>summary]:px-2 [&>summary]:font-[var(--font-mono)] [&>summary]:text-[length:var(--text-meta)] [&>summary]:font-semibold [&>summary]:tracking-[0.05em] [&>summary]:text-[var(--muted)] [&>summary]:uppercase [&>summary::-webkit-details-marker]:hidden [&>summary]:after:text-[var(--faint)] [&>summary]:after:content-['+'] [&>summary:hover]:border-[var(--border-strong)] [&>summary:hover]:text-[var(--text)] [&>summary[aria-current=page]]:border-[color-mix(in_srgb,var(--accent)_34%,var(--border))] [&>summary[aria-current=page]]:text-[var(--text)] group-open:[&>summary]:after:content-['−'] max-[680px]:[&>summary]:min-w-17",
  "orchestration-section-menu__body":
    "orchestration-section-menu__body absolute top-[calc(100%+6px)] left-0 z-8 grid min-w-42 gap-0.5 rounded-[var(--radius-sm)] border border-[var(--border-strong)] bg-[var(--surface-raised)] p-1.5 shadow-[0_16px_42px_color-mix(in_srgb,var(--shadow)_38%,transparent)] [&>button]:flex [&>button]:min-h-7.5 [&>button]:w-full [&>button]:items-center [&>button]:justify-between [&>button]:gap-3 [&>button]:rounded-[var(--radius-xs)] [&>button]:border-0 [&>button]:bg-transparent [&>button]:px-2 [&>button]:text-left [&>button]:text-[11px] [&>button]:text-[var(--text-soft)] [&>button:hover]:bg-[var(--surface-hover)] [&>button:focus-visible]:bg-[var(--surface-hover)] [&>button.selected]:bg-[color-mix(in_srgb,var(--accent)_7%,var(--surface-hover))] [&>button.selected]:text-[var(--text)] [&>button.selected]:shadow-[inset_2px_0_var(--accent)] [&_small]:font-[var(--font-mono)] [&_small]:text-[length:var(--text-meta)] [&_small]:text-[var(--muted)] max-[680px]:right-0 max-[680px]:left-auto",
  "orchestration-command-bar":
    "orchestration-command-bar flex items-center gap-1.25 max-[680px]:w-full max-[680px]:flex-wrap [&_.primary-button]:h-6.5 [&_.primary-button]:min-h-6.5 [&_.primary-button]:px-2 [&_.primary-button]:py-0.75 [&_.primary-button]:text-[length:var(--text-meta)] [&_.primary-button]:normal-case [&_.secondary-button]:h-6.5 [&_.secondary-button]:min-h-6.5 [&_.secondary-button]:px-2 [&_.secondary-button]:py-0.75 [&_.secondary-button]:text-[length:var(--text-meta)] [&_.secondary-button]:normal-case max-[680px]:[&_.primary-button]:flex-1 max-[680px]:[&_.secondary-button]:flex-1",
  "orchestration-supervision":
    "orchestration-supervision group relative [&>summary]:flex [&>summary]:min-h-6.5 [&>summary]:cursor-pointer [&>summary]:list-none [&>summary]:items-center [&>summary]:gap-1.25 [&>summary]:rounded-[var(--radius-xs)] [&>summary]:border [&>summary]:border-[var(--border)] [&>summary]:bg-[var(--surface-raised)] [&>summary]:px-2 [&>summary]:py-0.75 [&>summary]:text-[length:var(--text-meta)] [&>summary]:text-[var(--text-soft)] [&>summary::-webkit-details-marker]:hidden [&>summary_small]:font-[var(--font-mono)] [&>summary_small]:text-[length:var(--text-meta)] [&>summary_small]:text-[var(--muted)] [&>summary_i]:not-italic [&>summary_i]:text-[var(--muted)] [&>summary_i]:transition-transform group-open:[&>summary_i]:rotate-180 motion-reduce:[&>summary_i]:transition-none",
  "orchestration-supervision__body":
    "orchestration-supervision__body absolute top-[calc(100%+6px)] right-0 z-8 flex w-max items-center gap-1.75 rounded-[var(--radius-sm)] border border-[var(--border-strong)] bg-[var(--surface-raised)] p-2 shadow-[0_14px_36px_color-mix(in_srgb,var(--shadow)_36%,transparent)] [&_label]:text-[length:var(--text-meta)] [&_label]:tracking-[0.06em] [&_input]:h-6.5 [&_input]:min-h-6.5 [&_input]:w-10.5 [&_input]:px-2 [&_input]:py-0.75 [&_input]:text-[length:var(--text-meta)]",
  "orchestration-queue-starter":
    "orchestration-queue-starter mx-3 mt-3 mb-2 flex min-h-14 max-w-[640px] shrink-0 items-start gap-2.5 bg-transparent px-1 py-2 [&>.eyebrow]:shrink-0 [&>.eyebrow]:pt-px [&>.eyebrow]:text-[length:var(--text-meta)] [&>.eyebrow]:text-[var(--accent)] [&>div]:grid [&>div]:min-w-0 [&>div]:gap-0.5 [&_strong]:text-xs [&_strong]:text-[var(--text)] [&_small]:text-[10px] [&_small]:text-[var(--muted)]",
  ...
  "orchestration-pane-heading":
    "orchestration-pane-heading flex min-h-9 shrink-0 items-center justify-between gap-2.5 border-[var(--border)] border-b bg-[var(--surface)] px-2.5 py-1.75 font-[var(--font-mono)] text-[length:var(--text-meta)] font-bold tracking-[0.08em] text-[var(--text-soft)] uppercase [&_small]:text-[10px] [&_small]:font-medium [&_small]:tracking-normal [&_small]:text-[var(--muted)] [&_small]:normal-case",
  ...
  "orchestration-master-footer":
    "orchestration-master-footer flex items-center justify-between gap-2 px-2.25 pt-2 pb-0.5 font-[var(--font-mono)] text-[length:var(--text-meta)] text-[var(--muted)] [&_.secondary-button]:min-h-6.5 [&_.secondary-button]:px-1.75 [&_.secondary-button]:py-1 [&_.secondary-button]:text-[length:var(--text-meta)]",
  "orchestration-master-item":
    "orchestration-master-item grid min-h-13.75 w-full min-w-0 gap-1 rounded-none border border-transparent bg-transparent px-2.25 py-2 text-left text-[var(--text-soft)] transition-colors hover:bg-[color-mix(in_srgb,var(--accent)_5%,var(--surface-hover))] focus-visible:bg-[color-mix(in_srgb,var(--accent)_5%,var(--surface-hover))] [&_.badge]:min-h-4.5 [&_.badge]:rounded-[3px] [&_.badge]:px-1.25 [&_.badge]:py-0.5 [&_.badge]:text-[length:var(--text-meta)]",
  selected:
  ...
  "master-summary":
    "master-summary truncate text-[length:var(--text-meta)] leading-[1.35] text-[var(--muted)]",
  "master-meta-pills":
    "master-meta-pills inline-flex min-w-0 items-center gap-1.25 overflow-hidden font-[var(--font-mono)] text-[length:var(--text-meta)] leading-[1.2] text-[var(--text-soft)] whitespace-nowrap [&>span]:inline-flex [&>span]:min-w-0 [&>span]:items-center [&>span]:truncate [&>span]:rounded-full [&>span]:border [&>span]:border-[color-mix(in_srgb,var(--border)_74%,transparent)] [&>span]:bg-[color-mix(in_srgb,var(--surface-soft)_84%,transparent)] [&>span]:px-1 [&>span]:py-px [&>span]:text-[var(--muted)]",
  "orchestration-task-rail-meta":
    "orchestration-task-rail-meta block truncate text-[length:var(--text-meta)] leading-[1.25] text-[var(--muted)]",
  ...
  "orchestration-detail-tag":
    "orchestration-detail-tag inline-flex min-h-5 items-center rounded-full border border-[color-mix(in_srgb,var(--border)_76%,transparent)] bg-[color-mix(in_srgb,var(--surface-soft)_70%,transparent)] px-2 py-0 font-[var(--font-mono)] text-[length:var(--text-meta)] text-[var(--muted)]",
  ...
  "orchestration-action-deck":
    "orchestration-action-deck flex flex-wrap items-start justify-start gap-x-3 gap-y-2.25 p-0 [&_button]:min-h-6.75 [&_button]:px-2 [&_button]:py-1 [&_button]:text-[length:var(--text-meta)] [&_button]:tracking-normal [&_button]:normal-case [&_.text-button]:px-1.25 max-[900px]:flex-col",
  ...
  "orchestration-health-strip":
    "orchestration-health-strip grid grid-cols-3 gap-0 border-[var(--border)] border-b bg-[var(--border)] px-2 py-1.5 [&_span]:bg-[var(--surface)] [&_span]:px-1.5 [&_span]:py-1.75 [&_span]:text-center [&_span]:text-[length:var(--text-meta)] [&_span]:text-[var(--muted)] [&_strong]:text-[var(--text)]",
  ...
  "orchestration-mode-grid":
    "orchestration-mode-grid m-0 grid min-w-0 grid-cols-2 gap-0 border-0 px-2 py-1.25 [&>legend]:sr-only [&_button]:grid [&_button]:min-h-10 [&_button]:gap-0.5 [&_button]:rounded-none [&_button]:border [&_button]:border-transparent [&_button]:border-b-[var(--border)] [&_button]:bg-transparent [&_button]:p-1.5 [&_button]:text-left [&_button]:text-[var(--muted)] [&_button:hover]:bg-[var(--surface-hover)] [&_button:focus-visible]:bg-[var(--surface-hover)] [&_button.selected]:bg-[var(--surface-hover)] [&_button.selected]:text-[var(--text)] [&_strong]:text-[11px] [&_span]:text-[10px] [&_span]:leading-[1.35] [&_span]:text-[var(--muted)]",
