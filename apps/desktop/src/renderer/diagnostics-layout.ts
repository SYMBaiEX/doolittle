...
export const SETUP_GUIDANCE_TOOLBAR_CLASS =
  "flex items-center justify-between gap-4 py-2.5 max-[700px]:flex-col max-[700px]:items-stretch [&_p]:m-0 [&_p]:text-[length:var(--text-meta)] [&_p]:text-[var(--muted)]";

export const SETUP_GUIDANCE_LIST_CLASS = "m-0 grid list-none p-0";

export const SETUP_GUIDANCE_ITEM_CLASS =
  "grid min-h-[42px] grid-cols-[24px_minmax(0,1fr)_auto] items-start gap-[9px] border-t border-[var(--border)] py-[9px] text-[length:var(--text-control)] leading-[1.45] text-[var(--text-soft)]";
