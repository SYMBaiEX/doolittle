...
export const SETUP_READINESS_HEADING_CLASS =
  "flex items-start justify-between gap-5 max-[700px]:gap-2.5 [&>div]:grid [&>div]:min-w-0 [&>div]:gap-0.5 [&_h2]:m-0 [&_h2]:font-[var(--font-display)] [&_h2]:text-[clamp(20px,2vw,25px)] [&_h2]:leading-[1.08] [&_h2]:tracking-[-0.035em]";
