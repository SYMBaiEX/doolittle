...
const BASE_DESKTOP_TOKENS: Readonly<Record<string, string>> = {
  ...
  "--page-gap": "14px",
  "--page-pad-block": "26px 36px",
  "--page-pad-inline": "clamp(18px, 2.8vw, 42px)",
  "--page-header-min-height": "70px",
  "--page-header-pad-bottom": "13px",
  "--page-title-size": "clamp(24px, 2.2vw, 32px)",
  "--card-pad": "15px",
  "--row-pad": "9px",
  "--control-height": "32px",
...
const COMPACT_DESKTOP_TOKENS: Readonly<Record<string, string>> = {
  "--page-gap": "10px",
  "--page-pad-block": "18px 26px",
  "--page-pad-inline": "clamp(14px, 2.2vw, 30px)",
  "--page-header-min-height": "58px",
  "--page-header-pad-bottom": "10px",
  "--page-title-size": "clamp(21px, 2vw, 27px)",
  "--card-pad": "11px",
  "--row-pad": "6px",
  "--control-height": "28px",
};
