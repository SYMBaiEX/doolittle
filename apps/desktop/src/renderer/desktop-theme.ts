...
const BASE_DESKTOP_TOKENS: Readonly<Record<string, string>> = {
  ...
  "--page-title-size": "clamp(18px, 1.5vw, 22px)",
  "--chat-welcome-title-size": "clamp(22px, 2.4vw, 28px)",
  "--card-pad": "15px",
  "--row-pad": "9px",
  "--control-height": "32px",
...
const COMPACT_DESKTOP_TOKENS: Readonly<Record<string, string>> = {
  ...
  "--page-title-size": "clamp(17px, 1.35vw, 20px)",
  "--chat-welcome-title-size": "clamp(20px, 2.2vw, 25px)",
  "--card-pad": "11px",
  "--row-pad": "6px",
  "--control-height": "28px",
};
