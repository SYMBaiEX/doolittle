...
const BASE_DESKTOP_TOKENS: Readonly<Record<string, string>> = {
  ...
  "--page-title-size": "clamp(22px, 2vw, 29px)",
  "--chat-welcome-title-size": "clamp(28px, 3.2vw, 38px)",
  "--card-pad": "15px",
  "--row-pad": "9px",
  "--control-height": "32px",
...
const COMPACT_DESKTOP_TOKENS: Readonly<Record<string, string>> = {
  ...
  "--page-title-size": "clamp(20px, 1.8vw, 25px)",
  "--chat-welcome-title-size": "clamp(25px, 3vw, 33px)",
  "--card-pad": "11px",
  "--row-pad": "6px",
  "--control-height": "28px",
};
