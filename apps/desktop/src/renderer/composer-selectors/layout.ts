...
export const COMPOSER_PROJECT_TRIGGER_CLASS =
  "composer-project-trigger flex h-7.5 min-w-[96px] max-w-[180px] items-center gap-1.5 overflow-hidden rounded-[7px] border border-transparent bg-transparent pr-2 pl-1.5 text-[10px] text-[var(--muted)] hover:border-[var(--border)] hover:bg-[var(--surface-soft)] hover:text-[var(--text)] aria-expanded:border-[var(--border)] aria-expanded:bg-[var(--surface-soft)] aria-expanded:text-[var(--text)] max-[720px]:min-w-0 max-[720px]:max-w-34 max-[480px]:h-10 max-[480px]:w-10 max-[480px]:justify-center max-[480px]:px-0 max-[480px]:[&>svg]:hidden max-[480px]:[&>span:not([data-project-glyph])]:hidden [&>svg]:ml-auto [&>svg]:text-[var(--faint)] [&>span:not([data-project-glyph])]:truncate [&>span:not([data-project-glyph])]:font-semibold";
...
export const COMPOSER_MODEL_TRIGGER_CLASS =
  "composer-model-trigger flex h-7.5 min-w-0 max-w-[min(210px,30vw)] items-center gap-1.25 overflow-hidden rounded-[7px] border border-transparent bg-transparent px-2 py-1 text-[var(--muted)] hover:border-[var(--border)] hover:bg-[var(--surface-soft)] hover:text-[var(--text)] aria-expanded:border-[var(--border)] aria-expanded:bg-[var(--surface-soft)] aria-expanded:text-[var(--text)] max-[720px]:max-w-40 max-[480px]:h-10 max-[480px]:max-w-none max-[480px]:px-1.5 [&>svg]:shrink-0 [&>svg]:text-[var(--faint)]";
