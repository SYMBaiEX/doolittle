...
export const CATALOG_DETAIL_HEADER_CLASS =
  "flex items-start justify-between gap-[18px] border-b border-[var(--border)] pb-4 max-[520px]:flex-col max-[520px]:gap-[9px] [&>div]:min-w-0 [&_h2]:mt-[5px] [&_h2]:mb-1.5 [&_h2]:font-[var(--font-display)] [&_h2]:text-[clamp(16px,1.5vw,19px)] [&_h2]:font-semibold [&_h2]:leading-[1.14] [&_h2]:tracking-[-0.02em] [&_p]:m-0 [&_p]:max-w-[760px] [&_p]:text-[length:var(--text-body)] [&_p]:leading-[1.58] [&_p]:text-[var(--text-soft)]";
