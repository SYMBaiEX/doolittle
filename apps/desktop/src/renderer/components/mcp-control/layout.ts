...
export const MCP_HEADER_CLASS =
  "flex items-start justify-between gap-4 max-[760px]:flex-col [&_h2]:mt-1 [&_h2]:mb-0 [&_h2]:font-[var(--font-display)] [&_h2]:text-xl [&_p]:mt-[7px] [&_p]:mb-0 [&_p]:max-w-[620px] [&_p]:text-[13px] [&_p]:leading-[1.55] [&_p]:text-[var(--text-soft)]";
