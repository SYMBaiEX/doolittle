export const MESSAGE_RESPONSE_CLASS = [
  ...
  "[&_[data-streamdown=code-block-body]]:!h-auto [&_[data-streamdown=code-block-body]]:!min-h-0 [&_[data-streamdown=code-block-body]]:!max-h-[220px] [&_[data-streamdown=code-block-body]]:!overflow-y-auto [&_[data-streamdown=code-block-body]]:!overflow-x-hidden [&_[data-streamdown=code-block-body]]:!rounded-none [&_[data-streamdown=code-block-body]]:!border-0 [&_[data-streamdown=code-block-body]]:!border-t [&_[data-streamdown=code-block-body]]:!border-[var(--border)] [&_[data-streamdown=code-block-body]]:!bg-[var(--canvas-bg)] [&_[data-streamdown=code-block-body]]:!p-1.25 [&_[data-streamdown=code-block-body]]:!font-[var(--font-mono)] [&_[data-streamdown=code-block-body]]:!text-[10.5px] [&_[data-streamdown=code-block-body]]:!leading-[1.46] max-[480px]:[&_[data-streamdown=code-block-body]]:!max-h-[180px] [&_[data-streamdown=code-block-body]_pre]:!m-0 [&_[data-streamdown=code-block-body]_pre]:!min-h-0 [&_[data-streamdown=code-block-body]_pre]:!whitespace-pre-wrap [&_[data-streamdown=code-block-body]_pre]:break-words [&_[data-streamdown=code-block-body]_pre]:[overflow-wrap:anywhere]",
