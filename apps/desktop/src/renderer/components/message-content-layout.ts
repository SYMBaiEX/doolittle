export const MESSAGE_RESPONSE_CLASS = [
  "min-w-0 text-inherit [&>:first-child]:mt-0 [&>:last-child]:mb-0",
  ...
  "[&_blockquote]:my-[0.85em] [&_blockquote]:border-l-2 [&_blockquote]:border-[color-mix(in_srgb,var(--accent)_50%,var(--border))] [&_blockquote]:py-[0.05em] [&_blockquote]:pr-0 [&_blockquote]:pl-[0.85em] [&_blockquote]:text-[var(--muted)]",
  "[&_h1]:mt-[1.25em] [&_h1]:mb-[0.45em] [&_h1]:text-[1.3em] [&_h2]:mt-[1.15em] [&_h2]:mb-[0.4em] [&_h2]:text-[1.16em] [&_h3]:mt-[1em] [&_h3]:mb-[0.35em] [&_h3]:text-[1.04em] [&_h4]:mt-[0.9em] [&_h4]:mb-[0.3em] [&_h4]:text-[1em] [&_h1]:font-semibold [&_h2]:font-semibold [&_h3]:font-semibold [&_h4]:font-semibold",
  "[&_hr]:my-[1em] [&_hr]:h-px [&_hr]:border-0 [&_hr]:bg-[color-mix(in_srgb,var(--border)_72%,transparent)]",
  ...
  "[&_li]:my-[0.18em] [&_li]:pl-[0.1em] [&_ol]:pl-[1.35em] [&_ul]:pl-[1.35em]",
  "[&_[data-streamdown=code-block]]:!my-2.5 [&_[data-streamdown=code-block]]:!gap-0 [&_[data-streamdown=code-block]]:!rounded-[var(--radius-xs)] [&_[data-streamdown=code-block]]:!border-[var(--border)] [&_[data-streamdown=code-block]]:!bg-[var(--surface-soft)] [&_[data-streamdown=code-block]]:!p-0",
  "[&_[data-streamdown=code-block-header]]:!h-6.5 [&_[data-streamdown=code-block-header]]:!px-2 [&_[data-streamdown=code-block-header]]:!text-[length:var(--text-meta)]",
  ...
  "[&_[data-streamdown=code-block-body]]:!max-h-[420px] [&_[data-streamdown=code-block-body]]:!rounded-none [&_[data-streamdown=code-block-body]]:!border-0 [&_[data-streamdown=code-block-body]]:!border-t [&_[data-streamdown=code-block-body]]:!border-[var(--border)] [&_[data-streamdown=code-block-body]]:!bg-[var(--canvas-bg)] [&_[data-streamdown=code-block-body]]:!p-2.5 [&_[data-streamdown=code-block-body]]:!text-xs",
