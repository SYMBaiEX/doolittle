...
export const INTERACTIVE_TERMINAL_PRIMARY_BUTTON_CLASS =
  "min-h-6 rounded-[var(--radius-xs)] border border-[var(--accent)] bg-[var(--accent)] px-1.75 py-1 font-extrabold font-mono text-[9px] text-[var(--accent-ink)] uppercase tracking-[0.05em] hover:bg-[var(--accent-hover)] disabled:cursor-not-allowed disabled:opacity-50";
