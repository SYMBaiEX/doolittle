...
export const MEDIA_HEADING_CLASS =
  "col-span-full mb-[7px] flex min-h-6 items-center justify-between gap-4 [&>div]:min-w-0 [&_h2]:m-0 [&_h2]:font-[var(--font-display)] [&_h2]:text-base [&_h2]:font-semibold [&_h2]:leading-[1.2] [&_h2]:tracking-[-0.015em]";

export const MEDIA_FIELD_CLASS =
  "mb-[11px] grid gap-[5px] font-[var(--font-mono)] text-[var(--text-meta)] tracking-[0.06em] text-[var(--muted)] uppercase";
