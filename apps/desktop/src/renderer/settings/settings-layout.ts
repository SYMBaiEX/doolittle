export const SETTINGS_PAGE_CLASS = [
  ...
  "[&_.settings-model-section]:flex [&_.settings-model-section]:min-w-0 [&_.settings-model-section]:flex-col [&_.settings-model-section]:gap-4 [&_.settings-section-header]:flex [&_.settings-section-header]:min-h-15 [&_.settings-section-header]:items-start [&_.settings-section-header]:justify-between [&_.settings-section-header]:gap-5 [&_.settings-section-header]:border-[var(--line-subtle)] [&_.settings-section-header]:border-b [&_.settings-section-header]:pt-0.75 [&_.settings-section-header]:pb-3 [&_.settings-section-header_h2]:mt-1.25 [&_.settings-section-header_h2]:mb-0.5 [&_.settings-section-header_h2]:font-[var(--font-display)] [&_.settings-section-header_h2]:text-base [&_.settings-section-header_h2]:font-semibold [&_.settings-section-header_h2]:tracking-[-0.015em] [&_.settings-section-header_p]:m-0 [&_.settings-section-header_p]:text-[var(--muted)] [&_.settings-section-header_p]:text-[var(--text-meta)] [&_.settings-section-header_p]:leading-[1.5]",
].join(" ");
...
export const SETTINGS_CONTENT_HEADER_CLASS =
  "settings-content-header flex min-h-10.5 items-center justify-between gap-3 border-[var(--border)] border-b pt-0.25 pb-1.75 [&_h2]:mt-0.5 [&_h2]:mb-0 [&_h2]:text-base [&_p]:m-0 [&_p]:text-[var(--text-meta)] [&_p]:text-[var(--muted)]";
...
export const SETTINGS_INLINE_CHOICE_CLASS =
  "settings-inline-choice mt-0 flex min-h-10.5 items-center justify-between gap-4.5 px-2 py-1.5 max-[620px]:items-stretch max-[620px]:flex-col [&>div:first-child]:grid [&>div:first-child]:gap-0.25 [&>div:first-child_small]:text-[var(--text-meta)] max-[620px]:[&>fieldset]:w-full [&>fieldset]:flex [&>fieldset]:p-0.5 [&>fieldset_button]:min-h-6 [&>fieldset_button]:px-1.75 [&>fieldset_button]:py-0.75 max-[620px]:[&>fieldset_button]:flex-1";
...
export const SETTINGS_THEME_BUTTON_CLASS =
  "grid min-h-10.5 grid-cols-[28px_minmax(0,1fr)_12px] items-center gap-1.75 px-1.75 py-1.5 [&>strong]:truncate [&>strong]:text-[var(--text-meta)]";
