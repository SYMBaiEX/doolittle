...
describe("chat presentation components", () => {
  it("keeps composer controls, attachment affordance, and context meter together", () => {
    const props = {
      ...
      setPromptLibraryOpen: () => undefined,
      visiblePromptLibrary: [],
      promptScope: "general",
      setPromptScope: () => undefined,
      promptTitle: "",
      setPromptTitle: () => undefined,
      saveCurrentPrompt: () => undefined,
      editingPromptId: "",
      editingPromptTitle: "",
      setEditingPromptId: () => undefined,
      setEditingPromptTitle: () => undefined,
      finishPromptRename: () => undefined,
      restorePrompt: () => undefined,
      deletePrompt: () => undefined,
      beginPromptRename: () => undefined,
