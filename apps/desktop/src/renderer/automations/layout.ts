...
export const AUTOMATION_BUILDER_HEADER_CLASS =
  "automation-builder__header grid grid-cols-[minmax(0,1fr)_minmax(220px,0.55fr)] items-end gap-5 border-[var(--automation-line)] border-b px-5 py-4 max-[720px]:grid-cols-1 [&_h2]:mt-1 [&_h2]:mb-0 [&_h2]:font-[var(--font-display)] [&_h2]:text-base [&_h2]:tracking-[-0.02em]";
