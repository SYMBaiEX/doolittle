...
| [Desktop IA checklist](./desktop-information-architecture-checklist.md) | Track the consolidation to Home, Chat, Code, Work, and Settings with acceptance evidence. |
