...
| [Desktop IA checklist](./desktop-information-architecture-checklist.md) | Track the consolidation to Chat, Code, Settings, and contextual operations with acceptance evidence. |
