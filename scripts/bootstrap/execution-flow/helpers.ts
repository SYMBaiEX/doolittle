...
export function applyExecutionFlowResult(
  ...
  answers.discordApplicationId = result.discordApplicationId ?? "";
  answers.slackBotToken = result.slackBotToken ?? "";
  answers.slackAppToken = result.slackAppToken ?? "";
  answers.slackUserToken = result.slackUserToken ?? "";
  answers.slackWebhookUrl = result.slackWebhookUrl;
  answers.slackSigningSecret = result.slackSigningSecret;
  answers.whatsappAccessToken = result.whatsappAccessToken ?? "";
  answers.whatsappPhoneNumberId = result.whatsappPhoneNumberId ?? "";
  answers.whatsappVerifyToken = result.whatsappVerifyToken ?? "";
  answers.whatsappAppSecret = result.whatsappAppSecret ?? "";
  answers.signalAccountNumber = result.signalAccountNumber ?? "";
  answers.signalHttpUrl = result.signalHttpUrl ?? "";
  answers.signalCliPath = result.signalCliPath ?? "";
  answers.signalCliCommand = result.signalCliCommand ?? "";
