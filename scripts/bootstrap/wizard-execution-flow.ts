...
export async function runExecutionSelectionFlow(
  ...
  applyExecutionFlowResult(answers, {
    ...
    discordApplicationId: hands.discordApplicationId,
    slackBotToken: hands.slackBotToken,
    slackAppToken: hands.slackAppToken,
    slackUserToken: hands.slackUserToken,
    slackWebhookUrl: hands.slackWebhookUrl,
    slackSigningSecret: hands.slackSigningSecret,
    whatsappAccessToken: hands.whatsappAccessToken,
    whatsappPhoneNumberId: hands.whatsappPhoneNumberId,
    whatsappVerifyToken: hands.whatsappVerifyToken,
    whatsappAppSecret: hands.whatsappAppSecret,
    signalAccountNumber: hands.signalAccountNumber,
    signalHttpUrl: hands.signalHttpUrl,
    signalCliPath: hands.signalCliPath,
    signalCliCommand: hands.signalCliCommand,
